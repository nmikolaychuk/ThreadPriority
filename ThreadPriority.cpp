...
// ThreadPriority.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CThreadPriorityApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CThreadPriorityApp

CThreadPriorityApp::CThreadPriorityApp()
{
...
// Единственный объект CThreadPriorityApp

CThreadPriorityApp theApp;


// Инициализация CThreadPriorityApp

BOOL CThreadPriorityApp::InitInstance()
{
